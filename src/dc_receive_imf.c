                               ...
                               time_t* sort_timestamp, time_t* sent_timestamp, time_t* rcvd_timestamp)
{
	...
	*sort_timestamp = message_timestamp; /* truncated below  */
	...
	used to force fresh messages popping up at the end of the list:
		...
		* for sort_timestamp, to limit the impact if the local system time has been turned back (e.g. after a reset)
	*/
	...
	if (is_fresh_msg)
	{
		...
		/* sort to the end of chat if message delivery got delayed, by using a later sort_timestamp*/
